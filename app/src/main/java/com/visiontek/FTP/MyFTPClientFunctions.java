...
public class MyFTPClientFunctions {
	 ...
	 */
	public boolean ftpDownload(String srcFilePath, OutputStream desFilePath) {
		System.out.println("In ftpD : "+srcFilePath);
		System.out.println("In ftpD : "+desFilePath);
...
//			FileOutputStream desFileStream = new FileOutputStream(desFilePath);
			...
			status = mFTPClient.retrieveFile(srcFilePath, desFilePath);
	...
	public boolean ftpUpload(String srcFilePath, String desFileName,
		...
		System.out.println("FTP path : "+srcFilePath);
		System.out.println("FTP path : "+desDirectory);
		boolean status = false;
		try {
