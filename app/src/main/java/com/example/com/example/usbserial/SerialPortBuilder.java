...
import com.example.a97bt_usb_application.Utils;
...
public class SerialPortBuilder {
    ...
    public List<UsbDevice> getPossibleSerialPorts(Context context){
        ...
        List<UsbDevice> devices =  com.annimon.stream.Stream.of(allDevices.values())
    ...
    public boolean getSerialPorts(Context context){
        ...
        if(devices == null || devices.size() == 0) { // Not previous devices detected
            devices = com.annimon.stream.Stream.of(getPossibleSerialPorts(context))
            ...
            List<UsbDeviceStatus> newDevices = com.annimon.stream.Stream.of(getPossibleSerialPorts(context))
                    .map(UsbDeviceStatus::new)
